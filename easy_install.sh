...
export AWS_IOT_CREDENTIALS_ENDPOINT=`cat ./amazon-kinesis-video-streams-webrtc-sdk-c/iot/credential-provider-endpoint`
export AWS_IOT_ROLE_ALIAS=`cat ./amazon-kinesis-video-streams-webrtc-sdk-c/iot/role-alias`
...
`$KVS_WEBRTC_HOME/amazon-kinesis-video-streams-webrtc-sdk-c/build/samples/kvsWebrtcClientMasterGstSample` `cat ./amazon-kinesis-video-streams-webrtc-sdk-c/iot/thing-name`
EOF
